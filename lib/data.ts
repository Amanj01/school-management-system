...
export const calendarEvents = [
  ...
  },
  {
    ...
    end: new Date(currentYear, currentMonth, currentDate + 2, 8, 45),
  },
  {
    title: "Biology",
    allDay: false,
  ...
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(currentYear, currentMonth, currentDate + 2, 13, 0),
    end: new Date(currentYear, currentMonth, currentDate + 2, 13, 45),
  },
  {
    title: "History",
    allDay: false,
